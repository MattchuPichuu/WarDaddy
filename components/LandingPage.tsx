    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 relative overflow-hidden font-sans">
        ...
        <div className={`relative z-10 p-8 max-w-md w-full flex flex-col items-center text-center bg-slate-900/90 border border-slate-800 shadow-2xl rounded-xl transition-all duration-700 ease-out ${bootSequence ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="mb-8 relative w-32 h-32 flex items-center justify-center">
                <div className="absolute inset-0 border-2 border-brand-cyan/20 rounded-full animate-spin-slow"></div>
                <div className="absolute inset-2 border border-dashed border-slate-600 rounded-full animate-spin-reverse-slow"></div>
                
                <div className="relative z-10 bg-slate-950 p-4 rounded-full border border-brand-cyan/50 shadow-[0_0_20px_rgba(6,182,212,0.2)]">
                    <Shield className="w-12 h-12 text-brand-cyan" />
                </div>
                
                <div className="absolute inset-0 bg-brand-cyan/5 rounded-full animate-pulse"></div>
            </div>
